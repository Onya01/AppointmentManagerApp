...
import { filter, getDefault, openModal, notifyUser, getAppointments } from "./Lib";
...
if(name_ === "LevelOfImportance") {
  filter.LeveOfImportance = Number(v_) === 9 ? null : Number(v_);
}
        ...
        <h1>Manage Your Appointments / Dates very easy</h1>
          ...
          <section className="row justify-btw items-center filter">
            ...
            <div>
              ...
              <select name="LeveOfImportance" id="LeveOfImportance_f" defaultValue={8} onChange={filterApp} >
