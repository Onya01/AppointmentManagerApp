export const testData = [
    { ID: 1, Title: "Title one", Description: "Description one", LeveOfImportance: "3" , Date: "14-04-2023", Time: "17:32", Address: "Bc 85000" },
    { ID: 2, Title: "Title two", Description: "Description two", LeveOfImportance: "4" , Date: "13-04-2023", Time: "13:32", Address: "Bc 9000", },
    { ID: 3, Title: "Title one", Description: "Description three", LeveOfImportance: "5" , Date: "12-04-2023", Time: "10:32", Address: "Bc 2000" },
    { ID: 4, Title: "Title four", Description: "Description four", LeveOfImportance: "0" , Date: "10-04-2023", Time: "19:09", Address: "Bc 1000" },
]
...
export async function getDefault() {
    ...
    if(!res.ok && !res.status !== 200 ) {
        console.log("It sucked at getting default date: ", res)
...
export async function getAppointments(filter_) {
    ...
    if(!res.ok) {
        console.log("It sucked at getting appointments with filters: ", res)
