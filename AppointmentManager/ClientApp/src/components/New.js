...
export default function New(props){
    ...
    const postApp =()=> {
        postAppointment(entry).then(r => {
            console.log("Created new appointment successfully!: ", r)
    ...
    return (
        <div className="modal-container">
            ...
            <div className="mt-15">
                ...
                <input className="mt-5" type="text" id="Title_n" maxLength={150} name="title" onChange={newApp} />
                <span className="ms-10">0
                {titleLength} /150</span>
            </div>

            <div className="mt-15">
                <label htmlFor="
                Description_n">Description</label> <br />
                <textarea className="mt-5" id="Description_n" maxLength={300} name="description" onChange={newApp} cols={102} rows={10}></textarea> <br />
