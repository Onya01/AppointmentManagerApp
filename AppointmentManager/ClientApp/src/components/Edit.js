...
export default function Edit(props){
    ...
    const updateApp =()=> {
        ...
        .catch(e => console.log("Could not update the appointment"))
    ...
    useEffect(()=> {
        ...
        setImportance(entry.leveOfImportance)
        setData(entry)
    }, [props.stateListener])
    ...
    return (
        <div className="modal-container">
            ...
            <div className="mt-15">
                ...
                <input className="mt-5" type="text" id="Title_e" maxLength={150} name="title" defaultValue={data.title} onChange={editApp} />
                <span className="ms-10">0/150</span>
            </div>

            <div className="mt-15">
                <label htmlFor="Description_e">Description</label> <br />
                <textarea className="mt-5" id="Description_e" maxLength={300} name="description" defaultValue={data.description}  cols={102} rows={10} onChange={editApp}></textarea> <br />
            ...
            <div className="row mt-15">
                <div>
                    ...
                    <input type="text" id="Address_e" name="address" defaultValue={data.address} maxLength={100}  onChange={editApp} />
                </div>
